...
import { Reel, Product, Store, Customer } from '@shared/types';
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] p-8 text-center bg-black" dir="rtl">
        <Loader2 className="animate-spin text-vibrant-purple mb-4" size={40} />
  ...
  return (
    <div className="w-full h-screen absolute inset-0 bg-black select-none flex flex-col justify-between overflow-hidden transform-gpu backface-hidden p-0 m-0" dir="rtl">
      ...
      <div className="absolute top-0 inset-x-0 h-16 bg-gradient-to-b from-black/80 via-black/40 to-transparent z-40 flex items-center justify-between px-4 text-white font-tajawal">
        ...
        <button
          onClick={onShowCart}
          className="w-10 h-10 rounded-full bg-vibrant-purple text-white flex items-center justify-center hover:bg-violet transition active:scale-95 shadow-lg relative"
        >
          <ShoppingBag size={18} />
          {cartCount > 0 && (
                ...
                <div className="relative mb-2 flex flex-col items-center">
                  <div onClick={() => onVisitStore?.(reel.merchantId)} className="w-12 h-12 rounded-full p-[2px] bg-white border border-slate-900 overflow-hidden shadow-lg relative cursor-pointer hover:scale-105 transition">
                    {store?.logo ? (
                      ...
                      <div className="w-full h-full bg-vibrant-purple text-white flex items-center justify-center font-black text-xs">M</div>
                    )}
                  </div>
                    ...
                    <div className="flex items-center gap-2 pb-2 border-b border-white/10">
                      <div className="w-8 h-8 rounded-full p-[1px] bg-white overflow-hidden shadow">
                        {store.logo ? (
                          ...
                          <div className="w-full h-full bg-vibrant-purple text-white flex items-center justify-center font-black text-[10px]">M</div>
                        )}
                      </div>
                  ...
                  {product ? (
                    <>
                      ...
                      <button
                        ...
                        className="w-full py-2.5 bg-vibrant-purple hover:bg-violet active:scale-[0.97] transition text-white font-black text-xs sm:text-sm rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-vibrant-purple/25/20 cursor-pointer"
                      >
                        <ShoppingBag size={15} />
        ...
        <div className="absolute inset-x-0 bottom-0 h-[60%] bg-[#0B0D17] border-t border-white/10 rounded-t-3xl z-50 flex flex-col font-tajawal shadow-2xl overflow-hidden text-white animate-slide-up">
          ...
          <div className="p-3 bg-black/80 border-t border-white/5 flex gap-2 items-center">
            ...
            <button
              ...
              className="bg-vibrant-purple disabled:bg-slate-700 text-white font-extrabold text-xs px-4 py-2.5 rounded-xl"
            >
              إرسال
            </button>
          </div>
