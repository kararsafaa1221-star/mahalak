...
import { Store, PayoutRequest } from '@shared/types';
...
export const Wallet: React.FC<{
  ...
  return (
    <div className="space-y-6 animate-fade-in" dir="rtl">
      {/* Balance Card */}
      <div className="bg-gradient-to-l from-vibrant-purple to-[#7B3DFF] rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="w-full">
            <button 
              ...
              className="bg-white text-violet px-6 py-3 w-full rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-slate-50 transition active:scale-95 shadow-md"
            >
            ...
            <div className="p-6 space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full border-2 border-slate-200 focus:border-vibrant-purple p-4 rounded-2xl text-lg font-mono outline-none transition text-left"
              ...
              {(currentMerchant.payoutMethods?.zainCashNumber || currentMerchant.payoutMethods?.mastercardNumber) && (
                 <div className="p-4 bg-slate-50 text-slate-600 rounded-xl text-sm font-bold border border-slate-200">
                   ...
                   <span className="text-vibrant-purple mr-2" dir="ltr">
              ...
              <button 
                ...
                className="w-full bg-vibrant-purple hover:bg-violet text-white p-4 rounded-xl font-bold transition disabled:opacity-50 shadow-md flex items-center justify-center gap-2"
              >
                تأكيد طلب السحب
              </button>
            </div>
